...
(async () => {
  ...
  // Navigate to the external survey
  const surveyUrl = "https://ww3.unipark.de/uc/ttft1/?user=dc8f29e61e0c622da86f040074590f3be36ea8d9&user_id=25671709&task_id=209751787&job_id=467575551";
  ...
  fs.writeFileSync('D:\\_CLAUDE-TOOLS\\clickworker_llm_ext.png', Buffer.from(screenshot.data, 'base64'));
  console.log("\nScreenshot saved");
