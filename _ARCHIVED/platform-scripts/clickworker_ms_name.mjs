...
(async () => {
  ...
  // Enter first name
  let r = await setInput('#firstNameInput', 'Weber');
  console.log("First name:", r);

  // Enter last name
  r = await setInput('#lastNameInput', 'Gouin');
  ...
  fs.writeFileSync('D:\\_CLAUDE-TOOLS\\clickworker_ms_name.png', Buffer.from(screenshot.data, 'base64'));
  console.log("\nScreenshot saved");
