...
(async () => {
  ...
  // Navigate to UHRS assessment start
  await send("Page.navigate", { url: "https://workplace.clickworker.com/en/workplace/assessments/1081401/confirm_start" });
  await sleep(4000);
  ...
  fs.writeFileSync('D:\\_CLAUDE-TOOLS\\clickworker_uhrs.png', Buffer.from(screenshot.data, 'base64'));
  console.log("\nScreenshot saved");
