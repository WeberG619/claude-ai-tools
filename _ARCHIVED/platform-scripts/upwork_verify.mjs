...
async function main() {
  ...
  // Check specifically for city
  const hasSandpoint = page.body.includes('Sandpoint');
  const hasBuffalo = page.body.includes('Buffalo');
  console.log("\n--- RESULT ---");
  console.log("Has Sandpoint:", hasSandpoint);
  console.log("Has Buffalo:", hasBuffalo);
