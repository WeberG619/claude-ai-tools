...
(async () => {
  ...
  if (r !== 'not found') {
    ...
    // Check DataAnnotation
    const daTab = tabs2.find(t => t.type === "page" && (t.url.includes("dataannotation") || t.url.includes("google")));
    if (daTab) {
      const ws2 = new WebSocket(daTab.webSocketDebuggerUrl);
