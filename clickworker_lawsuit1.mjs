...
(async () => {
  ...
  // Navigate to the lawsuit job
  await send("Page.navigate", { url: "https://workplace.clickworker.com/en/workplace/jobs/1265827" });
  await sleep(4000);
  ...
  // Get all form fields and interactive elements
  r = await eval_(`
    const inputs = document.querySelectorAll('input, select, textarea, button, a.btn');
  ...
  fs.writeFileSync('D:\\_CLAUDE-TOOLS\\clickworker_lawsuit1.png', Buffer.from(screenshot.data, 'base64'));
  console.log("\nScreenshot saved");
