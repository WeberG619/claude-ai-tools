...
(async () => {
  ...
  ws.addEventListener("open", () => {
    ...
    (async () => {
      ...
      let btnPos = await eval_(`
        (function() {
          ...
          for (var i = 0; i < btns.length; i++) {
            ...
            if (t.includes('Start survey') || t.includes('Start Survey') || t === 'Start') {
      ...
      // Check what happened - survey should load
      ...
      // Check all targets - survey might open in new iframe or redirect
