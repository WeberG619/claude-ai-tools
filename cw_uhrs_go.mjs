...
(async () => {
  ...
  ws.addEventListener("open", () => {
    ...
    (async () => {
      // Navigate to UHRS job
      L("=== NAVIGATING TO UHRS ===");
      ...
      // Check for links, buttons, iframes
        ...
        (function() {
          ...
          document.querySelectorAll('a[href]').forEach(function(a) {
            ...
            if (t.length > 0 && t.length < 80) {
              results.push({ text: t.substring(0, 60), href: h.substring(0, 150) });
            }
          });
      ...
      writeFileSync('D:\\_CLAUDE-TOOLS\\cw_uhrs_go.png', Buffer.from(ss.data, 'base64'));
      L("\nScreenshot saved");
