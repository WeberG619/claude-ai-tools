...
(async () => {
  ...
  await send("Page.navigate", { url: "https://workplace.clickworker.com/en/workplace/payment_details/new" });
  await sleep(4000);
  ...
  fs.writeFileSync('D:\\_CLAUDE-TOOLS\\clickworker_payment.png', Buffer.from(screenshot.data, 'base64'));
  console.log("\nScreenshot saved");
